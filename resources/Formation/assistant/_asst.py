...
asst_p = "https://telegra.ph/file/e98db958e796347fb7d4b.jpg"
asst_c = "➥ **ASSISTANT IS:** `ONLINE`\n"
asst_c += f"➥ **My Boss** : {Def} \n"
asst_c += "➥ **Heroku Database** : `AWS - Working Properly`\n"
asst_c += "➥ **Copyright** : By [𝐋𝐈𝐓𝐇𝐎𝐍](https://github.com/SALAMSASA/L2)\n"
...
SetDec = "- 𝐋𝐈𝐓𝐇𝐎𝐍 𝘼𝙎𝙎𝙄𝙎𝙏𝘼𝙉𝙏 𝘽𝙊𝙏 🔱\n- ZED 𝘽𝙊𝙏 𝙁𝙊𝙍 ~ {}\n- 𝙎𝙊𝙐𝙍𝘾𝙀 𝘿𝙀𝙑 ~ @ll0llld 𖤨"
SetAbt = "- 𝙎𝙊𝙐𝙍𝘾𝙀 𝐋𝐈𝐓𝐇𝐎𝐍 🔱\n- ZED 𝘽𝙊𝙏 𝙁𝙊𝙍 ~ {}"
