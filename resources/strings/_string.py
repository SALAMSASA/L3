...
Start = (
    """
    <------------------------------------>
         يتم تحميل ملفات السورس ليثــون
    <------------------------------------>
    """
)
...
C = "**⌔╎المعادله ⪼** {}\n  **- الحل ⪼** {}"
Calc = (
    "𓆰 𝗦𝗢𝗨𝗥𝗖𝗘 𝐋𝐈𝐓 - 𝑪𝑨𝑳𝑪𝑼𝑳𝑨𝑻𝑶𝑹 𓆪\n"
    "◐━─━─━─━─**𝐋𝐈𝐓**─━─━─━─━◐\n"
    "**⌔╎قائـمه اوامر الحاسبه :** \n"
    "⪼ `.حاسبه` + المعادله \n"
    "◐━─━─━─━─**𝐋𝐈𝐓**─━─━─━─━◐\n"
    "𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝐋𝐈𝐓 - [𝘿𝙀𝙑](t.me/ll0llld) 𓆪"
)
...
StartLoaded = "<ⵧⵧⵧⵧⵧⵧ⫷ - LIT PLUGINS - ⫸ⵧⵧⵧⵧⵧⵧ>"
ASSISTANT = "<ⵧⵧⵧⵧⵧⵧ⫷ - LIT ASSISTANT - ⫸ⵧⵧⵧⵧⵧⵧ>"
KIMOTOSHA = "<ⵧⵧⵧⵧⵧⵧⵧⵧ⫷ - LIT TOSHA - ⫸ⵧⵧⵧⵧⵧⵧⵧ>"
ANIMATIONS = "<ⵧⵧⵧⵧⵧⵧ⫷ - LIT ANIMATIONS - ⫸ⵧⵧⵧⵧⵧ>"
ADMIN = "<ⵧⵧⵧⵧⵧ⫷ - LIT ADMIN TOOLS - ⫸ⵧⵧⵧⵧⵧ>"
ASSISTANTPM = "<ⵧⵧⵧⵧⵧ⫷ - LIT ASSISTANT PM - ⫸ⵧⵧⵧⵧⵧ>"
...
⫷ بوت ليثــون يعمل بنجاح الان ⫸
   ⫷ المستخدم: {} - البوت: {} ⫸
   ⫷ ارجع الى حسابك ودز الامر (.الاوامر) ⫸
⫷ @ll0llld - اذا كنت بحاجه الى مساعده فتوجه الى ⫸
⫷ @H_8_o - تحياتي : القائد صدام حسين ⫸"""
)

Mesg = [
    '⫷ يتم تحميل انلاين ليثــون ⫸',
    '⫷ اكتمل تنزيل انلاين ليثــون بدون اخطاء ⫸',
    '⫷ يتم بدء بوت ليثــون ⫸',
    '⫷ اكتمل بدء بوت ليثــون ⫸'
]
